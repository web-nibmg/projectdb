...
<html>
	...
	<head>
	    ...
	    <script language='javascript' type='text/javascript' src='/Data_Portal/Backend/js/jquery-2.1.4-uc.js'></script>
	...
	<body onload='initial_display();'>
			...
			<?php
				...
				//Redirects to Login page if values are not passed or in case of improper attempt...
					if(($_POST['email'] == '') || ($_POST['pwd'] == '') || ($_POST['type'] == '')){
						header('Location: /Data_Portal/Backend/index.html?flag=2');
						exit();
					}
					else{
				//Receive user inputs from "index.html"...
				...
				//Redirects to user page if the user is not Administrator...
						if($type == 'U'){
							header('Location: /Data_Portal/Backend/Uploader/Home_Users.php?flag=5');
							exit();
						}
				...
				//redirects to "index.html" if the query fails to execute...
						if(!$result){
							header('Location: /Data_Portal/Backend/index.html?flag=5');
							exit();
						}
				...
				//Redirects to Login page in case of password mismatch...
						if($pwd != $str){ 
							header('Location: /Data_Portal/Backend/index.html?flag=1');
							mysqli_close($cn);
							exit();
						}
				...
				//Sets the session variables if login is successful...
							...
							$_SESSION['home'] = '/Data_Portal/Backend/Admin/Home_Admin.php';
							$_SESSION['side_bar'] = '/Data_Portal/Backend/Admin/Sidebar_Admin.php';
			...
			<div class='container'>
				...
				<!--  -----------------------All Request Submit Table Starts---------------------- -->
					<div id='deleted_user_submit_table' style='overflow-x:auto;'>
						<form action='/Data_Portal/Backend/Admin/Edit_Delete.php' method='post' id='all_submit_form'>
		...
		<script language='javascript' type='text/javascript'>
			...
			function ajax_search(){
				...
				$.post('/Data_Portal/Backend/Admin/Edit_user_search.php', {search_name : edit_user_search_n, search_email : edit_user_search_e, search_type : edit_user_search_t}, function(data){
		...
		<script language='javascript' type='text/javascript'>
			...
			function du_ajax_search(){
				...
				$.post('/Data_Portal/Backend/Admin/Deleted_user_search.php', {search_name : edit_user_search_n, search_email : edit_user_search_e, search_type : edit_user_search_t}, function(data){
