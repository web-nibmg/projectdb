				...
				<div class='side_bar_inner'>
					<div class='side_bar_inner_inner'>
						<ul>
							...
							<li><a href='../App_Files/File_Adder.php'>File Uploader</a></li>
							<li><a href='../App_Files/Upload_History.php'>Upload History</a></li>
							<li><a href='../App_Files/Change_Password.php'>Change Password</a></li>
						</ul>
					</div>
				</div>
			</div>
