...
<html>
	...
	<head>
	    ...
	    <script language='javascript' type='text/javascript'>
			...
			function download_option(ext){
	    		...
	    		if(confirm('Download ' + 'Repository' + '.' + ext + '?')){
	   				//window.location = '../App_Hide/Download.php?flag=' + flag;
	   				alert('About to trigger...');
	   				window.location = '../App_Hide/Download.php?file_extension=' + ext;
	   				//window.location = '../App_Files/File_Adder_Admin.php?file_extension=' + ext;
		    	}
		    	else{return false;}
		    	//alert('continuing...');		    	
		    }		
		...
		/*	function download_option(ext){
				var file_first_name = 'Repository';
				
	    		if(confirm('Download ' + file_first_name + '.' + ext + '?')){
	   				//window.location = '../App_Hide/Download.php?flag=' + flag;
	   				alert('About to trigger...');
	   				$.post('../App_Hide/Download.php', {download_file_first_name : file_first_name, download_file_extenstion : ext});
	   				//	, function(data){
					//$("#display_error").html(data);//alert('done');
					//});
					return true;
		    	}
		    	else{return false;}
